...
addMateriel.addEventListener('click', e => {
    ...
    let tuple = "<td>" + nom.value + "</td><td>" + formatNumber(parseFloat(pu.value), 2, "Ar") + "</td><td>" + formatNumber(parseInt(quantite.value), 0) + "</td><td>" + formatNumber(parseFloat(total.value), 2, "Ar") + "</td><td class='d-inline-flex'><button onclick='editPiece(this)' class='btn btn-primary mr-2'><i class='fa fa-edit'></i></button><button onclick='removePiece(this)' class='btn btn-danger'><i class='fa fa-minus'></i></button></td>"
