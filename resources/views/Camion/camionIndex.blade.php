        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-supprimer-camion">
                <form action="#" method="POST" id="form-supprimer-camion">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-4">
                            <label for="name">Désignation : <x-not-editable-mark /></label>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-4">
                            <label for="marque">Marque : <x-not-editable-mark /></label>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-4">
                            <label for="model">Modèle : <x-not-editable-mark /></label>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-4">
                            <label for="annee">Année : <x-not-editable-mark /></label>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row mt-1">
                        <div class="col-sm-4">
                            <label for="numero_chassis">Numéro châssis : <x-not-editable-mark /></label>
                        </div>
                        <div class="col-sm-8">
